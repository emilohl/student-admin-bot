...
(() => {
  ...
  const T = {
    sv: {
      ...
      "chat.logging.on": "Loggning: på",
      "chat.logging.off": "Loggning: av",
      "chat.logging.on.tip": "Frågor lagras anonymt för att förbättra boten.",
      "chat.logging.off.tip": "Inget av det du skriver lagras.",
      "chat.logging.disable": "Stäng av",
      "chat.logging.enable": "Slå på",
      "chat.logging.disable.tip": "Stäng av loggning av dina frågor.",
      "chat.logging.enable.tip": "Slå på loggning igen.",
      ...
      "stats.chart.tokens_hist": "Tokens per fråga (histogram)",
      "stats.chart.tokens_hist.xlabel": "tokens per fråga",
      "stats.chart.ttft_hist": "Tid till första token (histogram)",
      "stats.chart.ttft_hist.xlabel": "ms",
      "stats.chart.ttft_hist.label": "tid till första token",
      "stats.chart.tps_hist": "Tokens per sekund (histogram)",
    ...
    en: {
      ...
      "chat.logging.on": "Logging: on",
      "chat.logging.off": "Logging: off",
      "chat.logging.on.tip": "Questions are stored anonymously to help improve the bot.",
      "chat.logging.off.tip": "Nothing you write is stored.",
      "chat.logging.disable": "Turn off",
      "chat.logging.enable": "Turn on",
      "chat.logging.disable.tip": "Stop logging your questions.",
      "chat.logging.enable.tip": "Turn logging back on.",
      ...
      "stats.chart.tokens_hist": "Tokens per request (histogram)",
      "stats.chart.tokens_hist.xlabel": "tokens per request",
      "stats.chart.ttft_hist": "Time to first token (histogram)",
      "stats.chart.ttft_hist.xlabel": "ms",
      "stats.chart.ttft_hist.label": "time to first token",
      "stats.chart.tps_hist": "Tokens per second (histogram)",
      "stats.chart.tps_hist.xlabel": "tokens/s",
