...
(() => {
  ...
  const T = {
    sv: {
      ...
      "chat.logging.on": "Loggning: på (frågor lagras anonymt för att förbättra boten)",
      "chat.logging.off": "Loggning: av (inget av det du skriver lagras)",
    ...
    en: {
      ...
      "chat.logging.on": "Logging: on (questions are stored anonymously to help improve the bot)",
      "chat.logging.off": "Logging: off (nothing you write is stored)",
